...
# sudo mount -t cifs //169.254.16.5/Susceptometry /mnt/susceptometry -o user=username,pass=password,dom=domain,vers=1.0
sudo mount -t cifs //172.20.3.6/Susceptometry /mnt/susceptometry -o user=username,pass=password,dom=domain,vers=1.0
